...
if (typeof window !== 'undefined' && !(window as any).api) {
  ...
  (window as any).api = {
    ...
    diagnostic: { checkAutoReply: noopObj, systemHealth: noopObj },
    ...
    kb: {
      ...
      exportKnowledge: () => Promise.resolve(''),
    ...
    escalation: { list: noopArray, resolve: noopObj },
    agent: { queue: noopArray, list: noopArray, assign: noopObj },
    buyer: {
